      ...
      [
        {
          ...
          Component: () => Promise.resolve().then(() => require("./index-BVnfu10n.js")),
        ...
        },
        {
          ...
          Component: () => Promise.resolve().then(() => require("./index-DL_kyirw.js")),
        ...
        },
        {
          ...
          Component: () => Promise.resolve().then(() => require("./index-BbN-IN0z.js")).then((mod) => ({
        ...
        },
        {
          ...
          Component: () => Promise.resolve().then(() => require("./index-CoScqJGB.js")).then((mod) => ({
...
exports.index = index;
//# sourceMappingURL=index--y8LTL2j.js.map
